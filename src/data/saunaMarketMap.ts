...
export const saunaOptions: SaunaOption[] = [
  ...
  },
  {
    ...
    examples: [],
    label: { offsetX: 0, offsetY: -9, anchor: "middle" },
  },
  {
    id: "infrared-sauna",
    name: "Infrared Sauna",
...
export const categoryBlobs: CategoryBlob[] = [
  ...
  },
  {
    ...
    colorFamily: "blue",
    opacity: 0.1,
    includedOptionIds: ["saunalife", "plunge-sauna"],
  ...
  },
  {
    ...
    opacity: 0.09,
    includedOptionIds: ["infrared-sauna", "sauna-blanket"],
    summary: "Easy-to-install radiant heat cabins and portable products that differ materially from traditional saunas.",
