...
const ContactCTA = () => {
  const handleReserveClick = (e: React.MouseEvent) => {
    ...
    trackAndNavigate(
      ...
      { location: "specs_contact_cta", amount: 500, currency: "USD" },
      () => {
      ...
      <div className="mx-auto max-w-[1320px] px-5 md:px-10 py-14 md:py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-center gap-3 max-w-md mx-auto sm:max-w-none">
          <a
            ...
            className="group inline-flex items-center justify-center gap-2 bg-[#111111] text-white text-center font-bold text-[16px] tracking-[0.025em] px-6 py-[11px] hover:bg-black transition-colors"
          >
            Reserve Yours
