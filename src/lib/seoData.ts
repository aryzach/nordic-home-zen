...
export const seoData = {
  ...
  home: {
    ...
    description: "The world's only plug-in sauna.",
  ...
  infraredSaunaSF: {
   ...
   finnishSaunaSF: {
     ...
     description: "Rent a steam sauna in San Francisco. Traditional high-heat experience at 170-200°F. Professional delivery and installation for homes and backyards.",
  ...
  reservationPayment: {
    ...
    canonical: "https://sfsaunarental.com/deposit"
  },
